# FANN_FOUND - system has fann FANN_INCLUDE_DIRS - the fann include directory
# FANN_LIBRARIES - Link these to use fann FANN_DEFINITIONS - Compiler switches
# required for using fann
#
...
if(FANN_LIBRARIES AND FANN_INCLUDE_DIRS)
  ...
  find_path(
    FANN_INCLUDE_DIR
    NAMES fann.h
    PATHS ${FANN_DIR}/include /usr/include /usr/local/include
  ...
  foreach(_lib ${_libraries})
    ...
    find_library(
      ${_name}_LIBRARY
      NAMES ${_lib}
      PATHS ${FANN_DIR}/lib /usr/lib/x86_64-linux-gnu/ /usr/lib /usr/local/lib
  ...
  set(FANN_LIBRARIES ${FANN_LIBRARIES} ${FANN_LIBRARY} ${DOUBLEFANN_LIBRARY}
