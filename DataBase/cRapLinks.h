...
#ifndef Qrap_cRapLinks_h
#define Qrap_cRapLinks_h
...
{
	/**
	 * The cRapLinks class inherits the basic Qt Widget class and this class is responsible
	 ...
	 */
	class cRapLinks : public QWidget
	{
		Q_OBJECT
