...
#ifndef Qrap_cRapRasterFiles_h
#define Qrap_cRapRasterFiles_h
...
{
	/**
	 * The cRapRasterFiles class inherits the basic Qt Widget class and this class is responsible
	 ...
	 */
	class cRapRasterFiles : public QWidget
	{
		Q_OBJECT
		...
		public:
			 ...
			 */
			cRapRasterFiles (QWidget* parent=0);
