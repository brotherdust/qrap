...
**
** Created: Sun Jul 27 20:11:33 2008
...
public:
    ...
    {
    BackupDialog->setWindowTitle(QApplication::translate("BackupDialog", "Backup & Restore", 0, QApplication::UnicodeUTF8));
