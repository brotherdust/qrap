...
#ifndef Qrap_cRapServedKeyLocations_h
#define Qrap_cRapServedKeyLocations_h
...
{
	/**
	 * The cRapServedKeyLocations class inherits the basic Qt Widget class and this class is responsible
	 ...
	 */
	class cRapServedKeyLocations : public QWidget
	{
		Q_OBJECT
		...
		public:
			 ...
			 */
			cRapServedKeyLocations (QWidget* parent=0);
			
			/**
			 * The destructor.
			 */
			~cRapServedKeyLocations ();
