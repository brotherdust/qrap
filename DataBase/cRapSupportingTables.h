...
#ifndef Qrap_cRapSupportingTables_h
#define Qrap_cRapSupportingTables_h
...
{
	/**
	 * The cRapSupportingTables class inherits the basic Qt Widget class and this class is responsible
	 ...
	 */
	class cRapSupportingTables : public QWidget
	{
		Q_OBJECT
		...
		public:
			 ...
			 */
			cRapSupportingTables (QWidget* parent=0);
			
			/**
			 * The destructor.
			 */
			~cRapSupportingTables ();
