 ...
 *    Description : This class displays all the tables related to a cells 
...
#ifndef Qrap_cRapCells_h
#define Qrap_cRapCells_h
...
{
	/**
	 * The cRapCells class inherits the basic Qt Widget class and this class is responsible
	 ...
	 */
	class cRapCells : public QWidget
	{
		Q_OBJECT
		...
		private:
			/**
			 * This function checks which table is selected and calls the relevant populate function.
			 */
			void PopulateTable ();
			...
			int				mCurrentCellId;		///< An integer that stores the current ID of the currently selected cell.
