...
#ifndef Qrap_cRapMeasurements_h
#define Qrap_cRapMeasurements_h
...
{
	/**
	 * The cRapMeasurments class inherits the basic Qt Widget class and this class is responsible
	 ...
	 */
	class cRapMeasurements : public QWidget
	{
		Q_OBJECT
		...
		public:
			 ...
			 */
			cRapMeasurements (QWidget* parent=0);
