...
IF(WIN32)
  ...
  IF (MINGW)
    FIND_PATH(GDAL_INCLUDE_DIR gdal.h /usr/include /usr/include/gdal c:/msys/local/include)
    FIND_LIBRARY(GDAL_LIBRARY NAMES gdal PATHS /usr/lib c:/msys/local/lib)
  ENDIF (MINGW)
